...
\usepackage[
  ...
  scale=1.3375 % font scale factor
  ]{beamerposter}
...
\newcommand{\footleft}{For a digital version of this poster \& more information, scan QR code (top right) or visit \url{www.jamesdossgollin.me/2016-12-11-agu/}}
...
\begin{frame}{}
  \begin{columns}[t]
    ...
    \begin{column}{0.18\linewidth}
        ...
        \input{blocks/big-picture.tex}
        \input{blocks/research-questions.tex}
    ...
    %-- Column 3 ---------------------------------------------------
    \begin{column}{0.18\linewidth}
        \input{blocks/synoptic.tex}
        \input{blocks/planetary.tex}
    ...
    \begin{column}{0.18\linewidth}
      ...
      \input{blocks/bayesian.tex}
      \input{blocks/model-inference.tex}
