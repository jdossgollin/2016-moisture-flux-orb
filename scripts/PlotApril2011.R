...
pacman::p_load(RNCEP, data.table, magrittr, lubridate, ggplot2, ggthemes, locfit, rstan, optparse)
...
storm_track <- ggplot() +
  ...
  geom_path(data = world, aes(x = long, y = lat, group = group), color = 'gray', alpha = 0.4) +
